...
import com.sawwere.backend.app.config.FileStorageConfig;
import com.sawwere.backend.app.exception.StorageException;
...
@Service
public class DefaultFileStorageService implements StorageService {
